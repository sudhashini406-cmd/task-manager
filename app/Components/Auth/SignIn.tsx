...
const SignIn = () => {
  ...
  // useEffect(() => {
  //   if (isPending) {
  //     const timer = setTimeout(() => setIsPending("false"), 3000); // Auto-stop after 3 sec
...
/>
      ...
      {/* </div><div className="max-w-md w-full bg-white p-10 shadow-lg rounded-lg"> */}
      <div className="max-w-md p-6 text-left bg-white rounded-lg shadow-lg absolute right-150 ">

      <h1 style={{ fontSize: "20px", fontWeight: "bold", color: "black", textAlign:"left"}}>Login</h1>


<p>Your account awaits. Enter your details to get
</p>
<p>started!</p>
<br/>
        <form
          onSubmit={handleSubmit(onSubmit)}noValidate className="flex flex-col space-y-4">
  ...
  {...register("email", {
    ...
    pattern: {
      ...
      value: /^[a-zA-Z0-9._%+-]+@(gmail\.com|gmial\.com)$/i,  // 'i' makes it case-insensitive
...
{errors.email && (
  <p className="text-red-500 text-sm">{errors.email.message}</p>
          ...
          <button
            ...
            //"w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 transition"
          >
